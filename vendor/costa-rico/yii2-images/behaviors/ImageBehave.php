...
//        $imageQuery->orderBy(['isMain' => SORT_DESC, 'id' => SORT_ASC]);
        ...
        $imageRecords = $imageQuery->all();   //ORIGINAL
//        $imageRecords = $imageQuery->where(['isMain' => null])->all();    //CHANGED BY ME. Т.к. главную изображение (isMain) попадала в общую галлерею
        if(!$imageRecords){
